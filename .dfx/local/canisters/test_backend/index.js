...
export const canisterId = process.env.TEST_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test_backend.did.js")._SERVICE>}
 */
