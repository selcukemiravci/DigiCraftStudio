...
export const canisterId = process.env.TEST_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test_frontend.did.js")._SERVICE>}
 */
export const test_frontend = createActor(canisterId);
